...
RESULTS_DIR = "results"
PRODUCT = "FubuMVC.JQueryMetaData"
COPYRIGHT = 'Copyright 2012 FubuMVC.JQueryMetaData. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  bottles("assembly-pak src/FubuMVC.JQueryMetaData -p FubuMVC.JQueryMetaData.csproj")

  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuMVC.JQueryMetaData.sln', :clrversion => CLR_TOOLS_VERSION
